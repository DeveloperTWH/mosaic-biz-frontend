...
function SearchPage() {
    ...
    // Simulate API call on filter/category change
        ...
        "SearchPage.useEffect": ()=>{
            const fetchFilteredProducts = {
                "SearchPage.useEffect.fetchFilteredProducts": async ()=>{
                    ...
                    // Simulated API call (replace this later with actual API)
                    const res = await fetch(`/api/fake-products?${query}`);
...
//# sourceMappingURL=_7ab96447._.js.map