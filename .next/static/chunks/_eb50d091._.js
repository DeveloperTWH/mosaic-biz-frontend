...
"[project]/app/(home)/search/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SearchPage.useEffect": ()=>{
            const fetchFilteredProducts = {
                "SearchPage.useEffect.fetchFilteredProducts": async ()=>{
                    setLoading(true);
                    ...
                    const filtered = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$home$292f$search$2f$Component$2f$data$2f$products$2e$json__$28$json$29$__["default"].filter({
                        "SearchPage.useEffect.fetchFilteredProducts.filtered": (product)=>{
                    ...
                    }["SearchPage.useEffect.fetchFilteredProducts.filtered"]);
                    // Simulate network delay (optional)
                    await new Promise({
                        "SearchPage.useEffect.fetchFilteredProducts": (r)=>setTimeout(r, 300)
                    }["SearchPage.useEffect.fetchFilteredProducts"]);
...
_s(SearchPage, "qVLlphEMMqDO++SThjCcbYMWX7Q=", false, function() {
    return [
...
//# sourceMappingURL=_eb50d091._.js.map