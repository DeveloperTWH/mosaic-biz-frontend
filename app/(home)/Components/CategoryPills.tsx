      ...
      {PILLS.map(({ label, href }) => {
        ...
        return (
          <Link
            key={href}
            href={href}
            className={`rounded-full px-4 py-2 font-poppins text-xs font-semibold uppercase tracking-wide transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-market-gold/50 focus-visible:ring-offset-2 focus-visible:ring-offset-market-bg ${
              active
