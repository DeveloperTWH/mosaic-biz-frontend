...
export default function VariationAttributes({
  ...
  const canAddAttribute = attributes.length < MAX_ATTRIBUTES;

  return (
    <div className="bg-white border border-gray-200 rounded-md p-5">
      <h2 className="text-base font-semibold text-gray-900 mb-4">Product Variations Attributes</h2>
...
/>
            ...
            {/* Generate Variants button below attributes, centered */}
            {attributes.length >= 1 && (
