  ...
  return (
    <div className="bg-gray-100 border border-gray-200 rounded-md p-5">
      ...
      <div className="space-y-4">
        ...
        {/* Request Category Creation Link */}
        <div className="text-sm text-[#c9a227] hover:text-[#b8921f] cursor-pointer">
          Can't find Your Category here? <span className="underline">Request Category Creation</span>
        </div>
      </div>
    </div>
  );
