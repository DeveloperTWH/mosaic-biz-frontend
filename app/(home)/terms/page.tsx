...
const Terms = () => {
  return (
    <div className="max-w-[900px] mx-auto p-8 font-sans leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">4. Vendor Accounts & Listings</h2>
        <p className="text-gray-700">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">5. Marketplace Transactions</h2>
        <p className="text-gray-700">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">10. Account Suspension & Termination</h2>
        <p className="text-gray-700">
