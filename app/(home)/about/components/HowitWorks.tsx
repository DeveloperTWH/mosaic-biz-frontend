...
const icons = [
  "/howitworks/browseIcon.png",
  "/howitworks/discoverIcon.png",
  "/howitworks/connectIcon.png",
  "/howitworks/supportIcon.png",
];
    ...
    <section className="bg-white">
      <div className="py-10 max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-4 text-gray-600 text-xs leading-relaxed max-w-3xl mx-auto font-inter">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-5 grid gap-2">
            <Image
              ...
              className="cursor-pointer hover:scale-105 transition-transform w-full h-[90px] object-contain"
            />
          ...
          {/* Right Content */}
          <div className="lg:col-span-7 bg-gray-50 p-6 flex items-center gap-4 min-h-[360px]">
