...
const CustomerTermsConditions = () => {
  return (
    <PublicContentLayout
      ...
      footer={
        <PolicyPageCta
          headline="SAFE • VERIFIED • TRUSTED"
          subheadline="EXPERIENCE COMMERCE WITH CONFIDENCE"
          body="Mosaic Biz Hub is committed to creating a transparent, inclusive, and secure marketplace where Customers and Vendors can connect with confidence."
          href="/vendors"
          linkLabel="Explore Vendors"
        />
      }
    >
