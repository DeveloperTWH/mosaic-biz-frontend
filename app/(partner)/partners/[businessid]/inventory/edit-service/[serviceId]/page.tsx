...
import CreateServiceForm from './EditServiceForm';

const page = () => {
    const { businessid, serviceId } = useParams() as { businessid : string ,serviceId: string };;
        ...
        <div className="flex h-screen bg-[#EBEAE2]">
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
                ...
                <main className="flex-1 p-2 space-y-6 overflow-y-auto lg:p-6">
                    ...
                    <CreateServiceForm businessId={business?._id} businessSlug={business?.slug} serviceId={serviceId} />
                </main>
            </div>
        </div>
    );
